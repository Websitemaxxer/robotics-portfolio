...
|--------|--------|----------|
| Guided projects completed (of 15) | 15 | 11 / 15 *(Spaceship Interface, Love-o-Meter, Color Mixing Lamp, Mood Cue, Light Theremin, Keyboard Instrument, Digital Hourglass, Crystal Ball, Knock Lock, Touchy-feely Lamp, Tweak the Arduino Logo; Projects 9 & 10 skipped for now — need a 9V battery)* |
...
- **Time:** ~11 hours so far *(Project 2 ~2 h; Project 3 ~35 min; Project 4 ~45 min; Project 5 ~2.5 h; Project 6 ~35 min; Project 7 ~25 min; Project 8 ~25 min; Project 11 ~1 h; Project 12 ~50 min; Project 13 ~40 min; Project 14 ~50 min; coding challenge — Reaction Timer ~40 min)*
