...
> **Status:** In progress (10 / 15 projects) &nbsp;·&nbsp; **Difficulty:** Beginner
...
|--------|--------|----------|
| Guided projects completed (of 15) | 15 | 10 / 15 *(Spaceship Interface, Love-o-Meter, Color Mixing Lamp, Mood Cue, Light Theremin, Keyboard Instrument, Digital Hourglass, Crystal Ball, Knock Lock, Touchy-feely Lamp; Projects 9 & 10 skipped for now — need a 9V battery)* |
| Self-designed extensions | ≥ 3 | 1 *(Touchy-feely Lamp — tuned the touch threshold to my setup)* |
...
- **Time:** ~9.65 hours so far *(Project 2 ~2 h; Project 3 ~35 min; Project 4 ~45 min; Project 5 ~2.5 h; Project 6 ~35 min; Project 7 ~25 min; Project 8 ~25 min; Project 11 ~1 h; Project 12 ~50 min; Project 13 ~40 min)*
