...
## 2026-07-08 — Coding challenge 1: Reaction Timer (my first from-scratch sketch, no help)

> Not a book project — a **coding challenge** I set myself *after* the guided builds, to
> prove I can write a kit-level sketch from just a spec. Code lives in
> `04_code/coding_challenges/challenge_01_reaction_timer/`.

- **Time spent:** ~40 minutes
- **Goal today:** Given only a goal, the behaviour and the pins (no coding help), write a reflex game: after a random 2–5 s wait an LED turns on; press a button as fast as possible; print the reaction time in ms; and catch a "false start" if the button is pressed before the LED. LED on **D8**, button on **D2** (10 kΩ pull-down), Serial at **9600**.
...
- **What worked (in the end):** The finished sketch does all six requirements — random GO light, accurate reaction time, self-restarting rounds, and a "Too soon!" false-start.
